...
export function InstanceSourceHint({ row }: InstanceSourceHintProps) {
  return (
    <ul className="space-y-0.5 text-xs text-[hsl(var(--muted-foreground))]">
      <li>
        <span className="font-medium text-[hsl(var(--foreground))]/80">Server (.env):</span>{" "}
      ...
      {row.profileOverride ? (
        <li>
          <span className="font-medium text-[hsl(var(--foreground))]/80">Your override:</span>{" "}
          <code className="break-all rounded bg-[hsl(var(--muted))] px-1 py-0.5 font-mono text-[11px]">
            {row.profileOverride}
          </code>
        </li>
      ...
      <li>
        <span className="font-medium text-[hsl(var(--foreground))]/80">In use:</span>{" "}
        <code className="break-all rounded bg-[hsl(var(--muted))] px-1 py-0.5 font-mono text-[11px]">
